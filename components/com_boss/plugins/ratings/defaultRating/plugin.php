...
class defaultRating extends mosDBTable
{
    ...
    function displayVoteResult($content, $directory, $prefix = "")
    {
        ...
        for ($i = 1; $i <= 5; $i++) {
            if ($result >= $i) {
                echo '<img src="' . JPATH_SITE . '/images/boss/' . $directory . '/plugins/ratings/defaultRating/images/' . $prefix . 'star_10.png" alt="star_10" align="middle" />';
            }
            else if ($result >= $i - 0.5) {
                echo '<img src="' . JPATH_SITE . '/images/boss/' . $directory . '/plugins/ratings/defaultRating/images/' . $prefix . 'star_05.png" alt="star_05" align="middle"/>';
            }
            else {
                echo '<img src="' . JPATH_SITE . '/images/boss/' . $directory . '/plugins/ratings/defaultRating/images/' . $prefix . 'star_00.png" alt="star_00" align="middle" />';
            }
        }
    }
}