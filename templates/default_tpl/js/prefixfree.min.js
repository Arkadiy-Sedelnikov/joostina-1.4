...
(function () {
    ...
    var a = window.StyleFix = {link:function (b) {
        ...
        g.onreadystatechange = function () {
            ...
            if (c && b.parentNode && (!g.status || g.status < 400 || g.status > 600)) {
                c = a.fix(c, !0, b), e && (c = c.replace(/url\(\s*?((?:"|')?)(.+?)\1\s*?\)/gi, function (a, b, c) {
    ...
    (function () {
        ...
        if (e.length > 0)for (var i = 0; i < e.length; i++)g(e[i]); else for (var j in e)g(StyleFix.deCamelCase(j));
        var k = {uses:0};
        for (var l in a) {
            var m = a[l];
        ...
        var b = {":read-only":null, ":read-write":null, ":any-link":null, "::selection":null}, d = {keyframes:"name", viewport:null, document:'regexp(".")'};
