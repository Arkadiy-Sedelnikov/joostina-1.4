...
<div class="details">
    <div class="boss_vote">
        <div>
            ...
            <?php if ($this->isRatingAllowed()) { ?>
                <div>
                    <?php $this->rating->displayVoteForm($content, $this->directory, $this->conf); ?><br/>
                </div>
            <?php } ?>
            <div>
	...
	<?php
	if ($this->countFieldsInGroup("DetailsSubtitle1"))
		$this->loadFieldsInGroup($content,"DetailsSubtitle1","<br/>",null,null,0);
	?>
    </div>
    <div class="details_subtitle2">
	<?php
	if ($this->countFieldsInGroup("DetailsSubtitle2"))
		$this->loadFieldsInGroup($content,"DetailsSubtitle2","<br/>",null,null,0);
	?>
    </div>
    <div class="details_subtitle3">
	<?php
	if ($this->countFieldsInGroup("DetailsSubtitle3"))
		$this->loadFieldsInGroup($content,"DetailsSubtitle3","<br/>",null,null,0);
	?>
    </div>
...
if ($this->countFieldsInGroup("DetailsDescription"))
	$this->loadFieldsInGroup($content,"DetailsDescription","&nbsp;");
?>
</div>
...
<div class="other">
<?php 
if ($this->countFieldsInGroup("DetailsFullText"))
	$this->loadFieldsInGroup($content,"DetailsFullText","<br/>");
?>
</div>

<div class="details_bottom">
<?php
if ($this->countFieldsInGroup("DetailsBottom"))
	$this->loadFieldsInGroup($content,"DetailsBottom","<br/>");
  echo '<br>';
