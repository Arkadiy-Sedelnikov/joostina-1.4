...
<div class="boss-rules">
	<a href="<?php echo JSef::getUrlToSef("index.php?option=com_boss&task=show_rules&directory=$this->directory"); ?>"
	   target=_blank>
...
<fieldset id="boss_fieldset" width="90%" align="center">
	...
	<span class="button"><input type="button" value="<?php echo BOSS_FORM_CANCEL_TEXT; ?>"
								onclick="javascript:history.go(-2)"/></span>
