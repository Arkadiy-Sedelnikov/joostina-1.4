...
/**
 * @package Joostina
 * @copyright јвторские права (C) 2008-2010 Joostina team. ¬се права защищены.
 ...
 * @param определ€ет пор€док сортировки: newest|oldest|popular|alpha|category
 */
