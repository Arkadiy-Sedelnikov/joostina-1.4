...
class SpawConfig{
	 ...
	 * @static
	 */
	public static function setStaticConfigValue($name, $value){
	 ...
	 */
	public static function setStaticConfigValueElement($name, $index, $value){
		$cfg_item = SpawConfig::getStaticConfigItem($name);
	 ...
	 */
	public static function getStaticConfigValueElement($name, $index){
		$cfg_item = SpawConfig::getStaticConfigItem($name);
