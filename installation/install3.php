...
<head>
	<title>Joostina Lotos - Web-установка. Конфигурация сайта.</title>
...
<div id="ctr" align="center">
	...
	<div class="install">
			...
			<div class="install-form">
				<div class="form-block">
					...
					<table class="content2" width="100%">
						...
						<tr class="trongate-1">
							<th>Ваш логин</th>
							<td><input class="inputbox" type="text" name="adminLogin" value="<?php echo $adminLogin; ?>" size="40"/>Используется как логин для авторизации главного Администратора сайта</td>
						</tr>

						<tr class="trongate-1">
							<th>Ваш E-mail</th>
							<td><input class="inputbox" type="text" name="adminEmail" value="<?php echo $adminEmail; ?>" size="40"/>Используется как адрес главного Администратора сайта</td>
						</tr>

						<tr class="trongate-2">
							<th>Пароль Администратора</th>
							<td>
								<input class="inputbox" type="text" name="adminPassword" id="adminPassword" value="<?php if($adminPassword != '') {
									echo $adminPassword;
								} else {
									mosMakePassword(8);
								} ?>" size="40"/>
		...
		<table cellpadding="1" cellspacing="1" border="0">
			<tr>
				<td>
					<input type="radio" id="filePermsMode0" name="filePermsMode" value="0" onclick="changeFilePermsMode(0)"<?php if(!$mode) {
			...
			<tr>
				<td>
					<input type="radio" id="filePermsMode1" name="filePermsMode" value="1" onclick="changeFilePermsMode(1)"<?php if($mode) {
						echo ' checked="checked"';
					} ?>/>
				</td>
				<td>
			...
			<tr id="filePermsFlags"<?php if(!$mode) {
				...
				<td>
					<table cellpadding="1" cellspacing="0" border="0">
						<tr>
							<td>Владелец:</td>
							<td>
								<input type="checkbox" id="filePermsUserRead" name="filePermsUserRead" value="1"<?php if($flags & 0400) {
									echo ' checked="checked"';
								} ?>/>
							</td>
							<td>
							...
							<td>
								<input type="checkbox" id="filePermsUserWrite" name="filePermsUserWrite" value="1"<?php if($flags & 0200) {
									echo ' checked="checked"';
								} ?>/>
							</td>
							<td>
							...
							<td>
								<input type="checkbox" id="filePermsUserExecute" name="filePermsUserExecute" value="1"<?php if($flags & 0100) {
									echo ' checked="checked"';
								} ?>/>
							</td>
							<td width="100%">
						...
						<tr>
							<td>Группа:</td>
							<td><input type="checkbox" id="filePermsGroupRead" name="filePermsGroupRead" value="1"<?php if($flags & 040) {
								echo ' checked="checked"';
							} ?>/></td>
							<td><label for="filePermsGroupRead">чтение</label></td>
							<td><input type="checkbox" id="filePermsGroupWrite" name="filePermsGroupWrite" value="1"<?php if($flags & 020) {
								echo ' checked="checked"';
							} ?>/></td>
							<td><label for="filePermsGroupWrite">запись</label></td>
							<td><input type="checkbox" id="filePermsGroupExecute" name="filePermsGroupExecute" value="1"<?php if($flags & 010) {
								echo ' checked="checked"';
							} ?>/></td>
						...
						<tr>
							<td>Все:</td>
							<td><input type="checkbox" id="filePermsWorldRead" name="filePermsWorldRead" value="1"<?php if($flags & 04) {
								echo ' checked="checked"';
							} ?>/></td>
							<td><label for="filePermsWorldRead">чтение</label></td>
							<td><input type="checkbox" id="filePermsWorldWrite" name="filePermsWorldWrite" value="1"<?php if($flags & 02) {
								echo ' checked="checked"';
							} ?>/></td>
							<td><label for="filePermsWorldWrite">запись</label></td>
							<td><input type="checkbox" id="filePermsWorldExecute" name="filePermsWorldExecute" value="1"<?php if($flags & 01) {
								echo ' checked="checked"';
							} ?>/></td>
...
<tr>
	...
	<td>
		...
		<table cellpadding="1" cellspacing="1" border="0">
			<tr>
				<td><input type="radio" id="dirPermsMode0" name="dirPermsMode" value="0" onclick="changeDirPermsMode(0)"<?php if(!$mode) {
					echo ' checked="checked"';
				} ?>/></td>
			...
			<tr>
				<td>
					<input type="radio" id="dirPermsMode1" name="dirPermsMode" value="1" onclick="changeDirPermsMode(1)"<?php if($mode) {
						echo ' checked="checked"';
					} ?>/>
				</td>
				<td>
			...
			<tr id="dirPermsFlags"<?php if(!$mode) {
				echo ' style="display:none"';
			} ?>>
				<td>&nbsp;</td>
				<td>
					<table cellpadding="1" cellspacing="0" border="0">
						<tr>
							<td>Владелец:</td>
							<td><input type="checkbox" id="dirPermsUserRead" name="dirPermsUserRead" value="1"<?php if($flags & 0400) {
								echo ' checked="checked"';
							} ?>/></td>
							<td><label for="dirPermsUserRead">чтение</label></td>
							<td><input type="checkbox" id="dirPermsUserWrite" name="dirPermsUserWrite" value="1"<?php if($flags & 0200) {
								echo ' checked="checked"';
							} ?>/></td>
							<td><label for="dirPermsUserWrite">запись</label></td>
							<td><input type="checkbox" id="dirPermsUserSearch" name="dirPermsUserSearch" value="1"<?php if($flags & 0100) {
								echo ' checked="checked"';
							} ?>/></td>
						...
						<tr>
							<td>Группа:</td>
							<td>
								<input type="checkbox" id="dirPermsGroupRead" name="dirPermsGroupRead" value="1"<?php if($flags & 040) {
									echo ' checked="checked"';
								} ?>/>
							</td>
							<td>
							...
							<td>
								<input type="checkbox" id="dirPermsGroupWrite" name="dirPermsGroupWrite" value="1"<?php if($flags & 020) {
									echo ' checked="checked"';
								} ?>/>
							</td>
							<td>
							...
							<td>
								<input type="checkbox" id="dirPermsGroupSearch" name="dirPermsGroupSearch" value="1"<?php if($flags & 010) {
									echo ' checked="checked"';
								} ?>/>
							</td>
							<td width="100%">
						...
						<tr>
							<td>Все:</td>
							<td>
								<input type="checkbox" id="dirPermsWorldRead" name="dirPermsWorldRead" value="1"<?php if($flags & 04) {
									echo ' checked="checked"';
								} ?>/>
							</td>
							<td>
							...
							<td>
								<input type="checkbox" id="dirPermsWorldWrite" name="dirPermsWorldWrite" value="1"<?php if($flags & 02) {
									echo ' checked="checked"';
								} ?>/>
							</td>
							<td>
							...
							<td>
								<input type="checkbox" id="dirPermsWorldSearch" name="dirPermsWorldSearch" value="1"<?php if($flags & 01) {
									echo ' checked="checked"';
								} ?>/>
							</td>
							<td width="100%">
